...
export class AssistantView extends LitElement {
    static styles = css`
        ...
        * {
        ...
        .send-button:disabled:active { transform: none; }
...
scrollToTop() {
    ...
    prefillTextInput(text) {
        ...
        if (!el) return;
        el.value = (text || '').trim();
        this.hasTypedText = el.value.trim().length > 0;
        this.adjustTextareaHeight(el);
    ...
    handleTextInput(e) {
        ...
        if (!el) return;
        const nextHasTypedText = el.value.trim().length > 0;
        if (nextHasTypedText !== this.hasTypedText) {
            this.hasTypedText = nextHasTypedText;
            this.requestUpdate();
        }
...
updateResponseContent() {
    ...
    render() {
        ...
        const sendDisabled = !this.hasTypedText;
        ...
        return html`
            ...
            <div class="text-input-container">
                <div class="input-row">
                    ...
                    ${this.inputFocused ? '' : html`<button class="send-button" @click=${() => this.handleSendText()} ?disabled=${sendDisabled}>
